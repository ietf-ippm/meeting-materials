...
* **URL**: https://datatracker.ietf.org/doc/draft-ietf-bmwg-mlrsearch/
* **State**: RFC editor queue
* **Mailinglist**: https://mailarchive.ietf.org/arch/browse/bmwg/?q=draft-ietf-bmwg-mlrsearch
* **Diff**: https://author-tools.ietf.org/diff?doc_1=draft-ietf-bmwg-mlrsearch
* **IETF Session**: 

### draft-ietf-bmwg-network-tester-cfg
* **URL**: https://datatracker.ietf.org/doc/draft-ietf-bmwg-network-tester-cfg/
* **State**: WGLC concluded. Giuseppe did shepherd review. Author is working on document update to address AD review.
...
* **State**: WGLC concluded and -06 revision addressed comments from WGLC. Sarah is document shepherd.
...
* **URL**: https://datatracker.ietf.org/doc/draft-ietf-bmwg-containerized-infra/
* **State**: -09 with minor editorial updates posted. No activities in the mailing list. Authors are waiting for the WGLC.
* **Mailinglist**: https://mailarchive.ietf.org/arch/browse/bmwg/?q=draft-ietf-bmwg-containerized-infra
* **Diff**: https://author-tools.ietf.org/diff?doc_1=draft-ietf-bmwg-containerized-infra
* **IETF Session**: 

### draft-ietf-bmwg-powerbench
* **URL**: https://datatracker.ietf.org/doc/draft-ietf-bmwg-powerbench/
* **State**: New revision posted. Inputs from a new coauthor. Giuseppe recommends cross review with GREEN WG.
...
* **State**: WG adoption call concluded. Plenty of feedback. Document updated and -01 revision posted. 
